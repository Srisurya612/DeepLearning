  ...
  with tf.compat.v1.Session(graph=detection_graph) as sess:
   ...
   while (ret):
      ...
      for i,b in enumerate(boxes[0]):
        ...
        #                 car                    bus                  truck
        if classes[0][i]==2 or classes[0][i] == 3 or classes[0][i] == 6 or classes[0][i] == 8 or classes[0][i]==4:
          if scores[0][i] >= 0.5:
            ...
            if apx_distance <=0.5:
              if mid_x > 0.3 and mid_x < 0.7:
                ...
                engine.runAndWait()
        if classes[0][i]==17 or classes[0][i]==18 or classes[0][i]==19 or classes[0][i]==20 or classes[0][i]==21 or classes[0][i]==22 or classes[0][i]==23 or classes[0][i]==24:
            if scores[0][i]>=0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                mid_y = (boxes[0][i][0]+boxes[0][i][2])/2
                apx_distance = round(((1-(boxes[0][i][3]-boxes[0][i][1]))**4),1)
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -Its an animal")
                        engine.say("Warning -Its an animal")
                        engine.runAndWait()
        
        if classes[0][i] ==44 or classes[0][i] ==46:
            if scores[0][i] >= 0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                mid_y = (boxes[0][i][0]+boxes[0][i][2])/2
                apx_distance = round(((1 - (boxes[0][i][3] - boxes[0][i][1]))**4),1)
                ...
                engine.say("units")
                engine.say("It might be a botle or a glass at safer distance")
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        ...
                        engine.runAndWait()
        if classes[0][i]==48 or classes[0][i]==49 or classes[0][i]==87:
            if scores[0][i]>=0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                mid_y = (boxes[0][i][0]+boxes[0][i][2])/2
                apx_distance = round(((1-(boxes[0][i][3]-boxes[0][i][1]))**4),1)
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -there is a Sharp Object")
                        engine.say("Warning - there is Sharp Object")
                        engine.runAndWait()
        if classes[0][i]==65:
            if scores[0][i]>=0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -You are approaching a bed")
                        engine.say("Warning -You are approaching a bed")
                        engine.runAndWait()
        if classes[0][i]==67:
            if scores[0][i]>=0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -You are approaching a dining table")
                        engine.say("Warning -You are approaching a dining table")
                        engine.runAndWait()
        if classes[0][i]==82:
            if scores[0][i]>=0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -You are approaching a refrigerator")
                        engine.say("Warning -You are approaching a refrigerator")
                        engine.runAndWait()
        if classes[0][i]==52 or classes[0][i] == 53 or classes[0][i] == 54 or classes[0][i] == 55 or classes[0][i]==56 or classes[0][i] == 57 or classes[0][i] == 58 or classes[0][i]==59:
              if scores[0][i] >= 0.5:
                  mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                  mid_y = (boxes[0][i][0]+boxes[0][i][2])/2
                  apx_distance = round(((1 - (boxes[0][i][3] - boxes[0][i][1]))**4),1)
                  ...
                  if apx_distance <=0.5:
                      if mid_x > 0.3 and mid_x < 0.7:
                          cv2.putText(image_np,'FOOD',(50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                          print("It is Food")
                          engine.say("Oh! it is food.I am starving")
                          engine.runAndWait()
     
    
        if classes[0][i]==73 or classes[0][i]==76 or classes[0][i]==76:
            if scores[0][i]>=0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                mid_y = (boxes[0][i][0]+boxes[0][i][2])/2
                apx_distance = round(((1-(boxes[0][i][3]-boxes[0][i][1]))**4),1)
                ...
                engine.say(apx_distance)
                engine.say("units")
                engine.say("It might be a mouse or a keyboard or a remote")
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Yeah! you are near the computer things")
                        engine.say("Yeah! you are near computer accessories")
                        engine.runAndWait()
        ...
        if classes[0][i]==90:
            if scores[0][i]>=0.5:
                ...
                engine.say(apx_distance)
                engine.say("units")
                engine.say("I think it is a tooth brush")
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("ToothBrush")
                        engine.say("It is time to Brush")
                        engine.runAndWait()
        if classes[0][i] ==77:
            if scores[0][i] >= 0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                ...
                engine.say(apx_distance)
                engine.say("units")
                engine.say("its a Mobile")
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("You are near the mobile")
                        engine.say("You are near mobile")
                        engine.runAndWait()
        if classes[0][i] ==72:
            if scores[0][i] >= 0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                ...
                engine.say(apx_distance)
                engine.say("units")
                engine.say("You are approaching a Television")
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -Television is very close")
                        engine.say("Warning -Television is very close to the frame")
                        engine.runAndWait()
